...
Эта работа применяет грамматику из предыдущей работы для построения [*Абстрактного синтаксического дерева*][AST] (Abstract Syntax Tree) для использования в следующих работах.
