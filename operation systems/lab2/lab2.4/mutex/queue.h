...
/**
 * Максимальная длина строки в узле (включая '\0').
 */
#define MAX_STRING_LENGTH 100

/**
 * Узел односвязного списка.
 * Содержит строку, указатель на следующий узел и мьютекс для защиты доступа.
 */
...
extern custom_mutex_t global_mutex; ///< Мьютекс для защиты счётчиков
